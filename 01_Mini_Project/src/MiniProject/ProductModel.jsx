...
import image from "../assets/product-modal/headphone.png";
import card from "../assets/product-modal/weight.png";
import heart from "../assets/product-modal/heart.png";

const ProductModel = () => {
	function Button({ children }) {
		return <button className="flex items-center justify-center py-3 px-5 space-x-3 border-2 border-gray-300 rounded-lg shadow-sm hover:bg-opacity-30 hover:shadow-lg hover:-translate-y-0.5 transition-all duration-150">{children}</button>;
	}
	...
	return (
		<div className=" flex justify-center items-center p-10">
			<div className="flex flex-col p-6 m-3 space-y-10 bg-white rounded-2xl shadow-2xl md:flex-row md:space-y-0 md:space-x-10 md:m-0 md:p-16">
				<div>
					<img src={image} alt="ProductImage" className="mx-auto hover:scale-105 duration-200 w-60" />
				</div>
				<div className=" flex flex-col space-y-6">
					<div className="flex flex-col mb-4 space-y-3 text-center md:text-left">
						...
						<div className="max-w-sm text-xl font-medium ">Razer Kraken Kitty Edt Gaming Headset Quartz</div>
						<div className="flex flex-col mb-4 space-y-3 text-center md:text-left">
							<p className="line-through">$799</p>
							<p className="text-5xl font-bold">$599</p>
							<p className="text-sm font-light text-gray-400">This offer vaild until April 3rd or as long as stock lasts!</p>
						</div>
						<div className="group ">
						...
						<div className="flex flex-col space-y-4 md:space-y-0 md:space-x-4 md:flex-row">
							...
							<Button>
								<img src={heart} alt="card" className="w-8" />
